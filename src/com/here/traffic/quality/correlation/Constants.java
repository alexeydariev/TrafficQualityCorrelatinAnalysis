...
public final class Constants {
	 ...
	 */
	public static final int RAW_PROBE_IDX_SAMPLE_DATE=0;
	public static final int RAW_PROBE_IDX_SYS_DATE=1;
	public static final int RAW_PROBE_IDX_VENDOR_DESC=2;
	public static final int RAW_PROBE_IDX_VEHICLE_ID=3;
	public static final int RAW_PROBE_IDX_COOR_Y=4;
	public static final int RAW_PROBE_IDX_COOR_X=5;
	public static final int RAW_PROBE_IDX_HEADING=6;
	public static final int RAW_PROBE_IDX_SPEED=7;
	public static final int RAW_PROBE_IDX_CTY_CODE=8;
	public static final int RAW_PROBE_IDX_TABLE_ID=9;
	public static final int RAW_PROBE_IDX_TMC_DIR=10;
	public static final int RAW_PROBE_IDX_TMC_POINT_LOC_CODE=11;
